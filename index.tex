...
\titre{Publications}
\label{sec:org7b88608}
\soustitre{Refereed papers (in English)}
\label{sec:org6f1a872}
...
\label{sec:org0864eb0}

\begin{itemize}
\item \textbf{Les déterminants naturels et politiques des AOC viticoles de
Côte-d’Or} (avec Mohamed Hilal). \emph{CyberGéo}, accepté 2021.
...
Mohamed Hilal and Marjorie Ubertosi). \emph{UMR CESAER Working Papers
2012-1}, 2012 [ \href{http://ideas.repec.org/p/ceo/wpaper/33.html}{link} ]
\item \textbf{Informations sur le foncier agricole pour contribuer à la
gestion de l'eau}. \emph{UMR CESAER Working Papers 2011-6}, 2011 [
...
\label{sec:orgb4ef1ce}

\begin{itemize}
\item \textbf{The signaling values of nested wine names}. With Julie Le Gallo.
...
\label{sec:orgf38a1a5}
\soustitre{Research programs}
\label{sec:org5a1ee49}
