...
\titre{Publications}
\label{sec:orgbf97d5b}
\soustitre{Refereed papers (in English)}
\label{sec:orgc2e9571}
...
\label{sec:orgcd18210}

\begin{itemize}
\item \textbf{Hedonic valuation of geographical indications with unobserved
terroir effects}. With Julie Le Gallo.
\item \textbf{The informational content of geographical indications}. [ \href{http://XXX.pdf}{file} ]
...
\label{sec:org6182959}
\soustitre{Research programs}
\label{sec:orgfea3fb8}
