...
\label{sec:org43b8bfe}

\begin{description}
\item[{Land Economics}] Study of land use decisions and land price
dynamics in relation to agricultural, environmental, and urban
outcomes. Analysis of the effects of public policies on land use
patterns and land values.
\item[{Wine Economics}] Investigation of consumer preferences for wine
attributes, vineyard pricing linked to geographical indications,
and environmental influences. Evaluation of public policy impacts
on the wine sector.
\item[{Applied Econometrics}] Expertise in spatial econometrics,
geographically weighted regression, causal inference, instrumental
variables, best linear unbiased prediction, and discrete choice
modeling.
\end{description}
\titre{Current papers}
\label{sec:org096336b}
...
\end{itemize}
\titre{Publications}
\label{sec:org91bbc82}
\soustitre{Refereed papers (in English)}
\label{sec:orgaf0d9ac}
...
\end{itemize}
\soustitre{Other documents}
\label{sec:org416b3c6}
...
\label{sec:org00cfa37}
\soustitre{Research programs}
\label{sec:org7a3e36a}
