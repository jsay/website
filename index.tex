...
\textbf{Web pages:} & \href{http://github.com/jsay/}{GitHub} / \href{https://cesaer.dijon.hub.inrae.fr/membres/personnel-scientifique/ay-jean-sauveur}{Institutional} / \href{https://ideas.repec.org/e/pay77.html}{RePEc} / \href{https://www.researchgate.net/profile/Jean\_Sauveur\_Ay}{ResearchGate} / \href{https://scholar.google.fr/citations?user=arEwxlIAAAAJ\&hl=fr}{Scholar}\\
\end{tabular}
\end{center}
\titre{Research interest}
\label{sec:org9e16379}

\begin{description}
\item[{Land Economics}] Inter-disciplinary researches on agricultural,
environmental, and urban outcomes,
\item[{Wine Economics}] Economics of geographical indications,
consumers' preferences, and pest diseases,
\item[{Applied Econometrics}] Causal inference, spatial econometrics,
and more structural approaches.
\end{description}
\titre{Professional experience}
\label{sec:org5a05794}

\begin{center}
\begin{tabular}{ll}
2014 to now & \textbf{Researcher} at INRAE, \href{https://www2.dijon.inrae.fr/cesaer/en/axis/}{UMR Cesaer}, Dijon\\
April 2026 & \textbf{Visiting scolar} at \href{https://bren.ucsb.edu/}{Bren School}, UC Santa Barbara\\
...
2011 to 2013 & \textbf{Postdoctoral fellow} at CNRS-MNHN, \href{http://cesco.mnhn.fr/en}{UMR Cesco}, Paris\\
\end{tabular}
\end{center}
\titre{Education}
\label{sec:org6f72b23}

\begin{center}
\begin{tabular}{ll}
2008 to 2011 & \textbf{PhD in Economics} at INRA and \href{http://en.u-bourgogne.fr/}{Université de Bourgogne}\\
2007 to 2008 & \textbf{M.Sc. in Economics} at \href{https://www.parisschoolofeconomics.eu/en/}{PSE, Paris School of Economics}\\
2005 to 2008 & \textbf{M.Sc. in Economics} at \href{https://www.amse-aixmarseille.fr/en}{Université Aix-Marseille II}\\
\end{tabular}
\end{center}
\titre{Current papers}
\label{sec:orgd283315}

\begin{itemize}
\item \textbf{Prestigious wine grade designation} (with Julie Le Gallo) [ \href{https://wine-economics.org/wp-content/uploads/2021/05/AAWE\_WP265.pdf}{wp} ]
...
\item \textbf{Return on investment for promoting homeownership: The case of
the French interest-free loan policy} (with Rémi Lei and Julie Le
Gallo) [ \href{doc/CEREM-FILE.pdf}{file} ]
...
\item \textbf{The dynamic impact of land-use changes on soil organic carbon}
(with Liang Diao and Valentin Bellassen) [ \href{doc/DSOIL-FILE.pdf}{file} ]
\end{itemize}
\titre{Publications}
\label{sec:org5b01c07}
\soustitre{Refereed papers (in English)}
\label{sec:org2353739}

\begin{itemize}
\item \textbf{Strategic free-riding in pest control: Theory and evidence in
organic-conventional mixed landscapes}. (with François Bareille
and Vincent Martinet) \emph{Journal of Environmental Economics and
Management}, 2026, 138 [ \href{https://www.sciencedirect.com/science/article/pii/S0095069626000665}{link} ]
\item \textbf{The social stratification of homeowners' housing wealth:}
\textbf{Bringing a dynamic approach through the price gap index}. (with
Thibault Le Corre) \emph{Environment and Planning B: Urban Analytics
and City Science}, 2025, 103(2): 523--542 [ \href{bib/PPL.bib}{bib} ; \href{doc/PPL-FILE.pdf}{file} ; \href{https://github.com/jsay/PriceGapIndex}{online} ;
\href{https://journals.sagepub.com/doi/10.1177/23998083251339296}{link} ]
...
\label{sec:org4e50c83}

\begin{itemize}
\item \textbf{Mises en oeuvre de démarches agroécologiques dans des régions
viticoles françaises} (avec Patrice This, Emna Troudi, Marie
Thiollet-Scholtus et autres). \emph{Innovations Agronomiques}, 2025. [
\href{bib/DNPA.bib}{bib} ; \href{https://hal.inrae.fr/hal-05010342v1/document}{link} ]
...
Gestion des Sols}, 2020, 27:147--161. [ \href{bib/ESOL.bib}{bib} ; \href{doc/ECOSOL-FILE.pdf}{file} ; \href{https://www.afes.fr/ressources/numero-special-egs-fonctions-des-sols-et-services-ecosystemiques/}{link} ]
...
\end{itemize}
\soustitre{Other publications}
\label{sec:org9151b82}

\begin{itemize}
\item \textbf{Préserver la qualité des sols: Vers un référentiel
d’indicateurs.} (avec Isabelle Cousin, Maylis Desrousseaux,
Sophie Leenhardt et autres). \emph{Expertise collective INRAE}, 2025,
{[} \href{https://college-de-france.hal.science/hal-04934694/}{link} ]
...
déterminants, impacts et leviers d'action} (avec Béatrice Béchet,
Yves Le Bissonnais, Anne Ruas, Bertrand Schmitt et autres)
\emph{Expertise collective INRA-IFSTTAR}, 2017, [ \href{https://www.inrae.fr/actualites/sols-artificialises-processus-dartificialisation-sols}{link} ]
...
\end{itemize}
\titre{Communications}
\label{sec:org3c7de58}

\begin{description}
\item[{2026}] \textbf{emLab seminary} (April, Santa Barbara, USA)
\item[{2025}] \textbf{Jeudis Expertise Vigne \& Vin} (April, Dijon, France) ;
\textbf{Colloque OMISEP} (June, Marseille, France) ; \textbf{Conseil
scientifique FNSAFER} (October, Paris, France) ; \textbf{Conférence
Chaire UNESCO} (November, Dijon, France) ; \textbf{Séminaire FAR}
(November, Paris, France).
\item[{2024}] \textbf{Séminaire FAR} (June, Paris, France) ; \textbf{Séminaire INED}
(June, Paris, France) ; \textbf{Final Meeting SERENA} (October, Orléans,
France) ; \textbf{Journées de Recherches en Sciences Sociales} (December,
Reims, France).
...
France).
\item[{2022}] \textbf{Séminaire FAR} (March, Paris, France) ; \textbf{Wine and Spirit
Seminar of the Burgundy School of Business} (June, Dijon, France)
; \textbf{Association Française de Sciences Économiques} (June, Dijon,
France)
\item[{2021}] \textbf{Journées INRAE--SFER--CIRAD} (March, Anger, France) ;
\textbf{Atelier Vin et Société at Institut d’études avancées} (April,
Paris, France) ; \textbf{Séminaire SMART-LERECO} (October, Rennes,
France) ; \textbf{Journées Recherches en Sciences Sociales} (December,
Toulouse, France)
...
\label{sec:org7af0f15}
\soustitre{Research programs}
\label{sec:org6d544bc}

\begin{itemize}
\item \href{https://www.inrae.fr/en/news/ruralitic-rethinking-european-rural-areas-face-new-realities-challenges-and-transitions}{RURALITIC} (2025-2028) from European Union, \emph{Horizon Europe}
\item \href{https://anr.fr/Projet-ANR-23-CE41-0007}{OPOSOM} (2024-2026) from ANR, \emph{Agence Nationale de la Recherche}
\item \href{https://anr.fr/Project-ANR-23-CE55-0008}{LAMARTINE} (2023-2026) from ANR, \emph{Agence Nationale de la
Recherche}
\item \href{https://www.plan-deperissement-vigne.fr/recherches/programmes-de-recherche/risca-ii}{Risca 2} (2023-2026) from \emph{Plan National Dépérissement du
Vignoble}
\item \href{https://ejpsoil.eu/soil-research/serena}{SERENA} (2022-2025) from EJP SOIL, \emph{European Joint Program}
\item \href{https://anr.fr/Project-ANR-21-CE03-0007}{LOCUS} (2022-2025) from ANR, \emph{Agence Nationale de la Recherche}
\item \href{https://www.ademe.fr/en/frontpage/}{OMISEP} (2022-2024) from \emph{ADEME}, \emph{Agence de la Transition
Écologique}
\item \href{http://www.ubfc.fr/pubprivlands/}{PubPrivLands} (2019-2021) from \emph{Région Bourgogne Franche-Comté
(ISIT-BFC)}
\item \href{https://www.plan-deperissement-vigne.fr/travaux-de-recherche/programmes-de-recherche/risca}{Risca} (2019-2021) from \emph{Plan National Dépérissement du Vignoble}
\item \href{https://www.trustee-project.eu/}{Trustee} (2013-2017) from EU FP7, \emph{ERA-NET RURAGRI program}
\item \href{https://www.fondationbiodiversite.fr/en/}{Mobilis} (2012-2013) from FRB, \emph{Fondation pour la Recherche sur la
Biodiversité}
\item \href{http://www.gessol.fr/content/integrer-la-valeur-epuratrice-de-sols-hydromorphes-dans-leur-usage-quelles-strategies-d-inte}{EcoSolHydro} (2011-2012) from ADEME and MEEDE, \emph{GESSOL program}
\end{itemize}
\soustitre{Teaching experience}
\label{sec:orgd136166}

\begin{center}
\begin{tabular}{llrll}
\textbf{Course} & \textbf{Place} & \textbf{Hours} & \textbf{Formation} & \textbf{Period}\\
\hline
Wine Economics & Institut Agro Dijon & 3 & Postgrad. & 2016, 2026 (2 yrs)\\
Econometrics & SciencesPo Dijon & 24/48 & Undergrad. & 2018--2026 (8 yrs)\\
...
\label{sec:orgb1d06ff}

\vspace{.5cm}

Acta Oeconomica (1), Agricultural Economics (1), American Journal
of Agricultural Economics (1), Applied Economics (1), Ecological
Economics (2), Économie et Statistique (2), Économie Rurale (3),
Environmental Modeling and Assessment (2), Environment and Planning
A (1), Environmental and Resource Economics (1), European Review of
Agricultural Economics (3), Geoderma (1), International Journal of
Geographical Information Science (1), International Journal of
Strategic Property Management (1), Journal of Agricultural
Economics (1), Journal of Environmental Management (3), Land
Economics (1), OENO One (1), Plos One (1), Regional Studies (1),
Review of Agricultural, Food and Environmental Studies (2), Revue
Économique (1), Revue d'Économie Régionale et Urbaine (3), Spatial
Economic Analysis (2), Spatial Statistics (1), Sustainability (1).

\vspace{.5cm}
\soustitre{Miscellaneous}
\label{sec:org9f7a7ee}

\begin{itemize}
\item Coordinator of FAR network about Agricultural and Rural Lands at
INRAE,
...
\item Expert in a scientific team about "Soil quality indicators",
...
\item Other: \href{https://distillerie-mazy.fr/}{Distillerie Mazy} in Burgundy and \href{https://www.gigondas-vin.com/vigneron/domaine-raspail-ay/}{Domaine Raspail-Ay} in
Rhône Valley.
\end{itemize}
\end{document}
