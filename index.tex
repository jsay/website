...
\label{sec:org9eda7ab}

\begin{center}
\begin{tabular}{ll}
2014 to now & \textbf{Researcher} at INRA, \href{https://www2.dijon.inrae.fr/cesaer/en/axis/}{UMR Cesaer} Dijon\\
...
\titre{Publications}
\label{sec:org0db2663}
\soustitre{Refereed papers (in English)}
\label{sec:org6071ceb}

\begin{itemize}
\item \textbf{Willingness-to-pay for reshuffling geographical indications}
(with Monia Saïdi, Stéphan Marette and Christophe
Martin). \emph{Journal of Wine Economics}, 2020, accepted [ \href{bib/GEOIND.bib}{bib} ; \href{doc/RFGI-FILE.pdf}{file}
; \href{doc/RFGI-SUP.pdf}{sup} ; \href{https://github.com/jsay/reshufGI/}{online} ]
\item \textbf{The informational content of geographical
indications}. \emph{American Journal of Agricultural Economics}, 2020,
early view [ \href{bib/GEOIND.bib}{bib} ; \href{doc/GEOIND-FILE.pdf}{file} ; \href{doc/GEOIND-SUP.pdf}{sup} ; \href{https://github.com/jsay/geoInd/}{online} ; \href{https://onlinelibrary.wiley.com/doi/full/10.1111/ajae.12100}{link} ]
...
Modeling}, 2020, early view [ \href{bib/SPFD.bib}{bib} ; \href{doc/SPFD-FILE.pdf}{file} ; \href{doc/SPFD-PRES.pdf}{pres} ; \href{https://onlinelibrary.wiley.com/journal/19397445}{link} ]
...
Julie Le Gallo.
\item \textbf{La capitalisation du prix des vins dans le prix des
vignes}. With Abdoul Diallo and Hai-Vu Pham.
\item \textbf{Compliance with compulsory treatments.} With Estelle Gozlan and
Emmanuel Paroissien.
\end{itemize}

\titre{Communications}
\label{sec:orgfe3e1fb}
...
\label{sec:orga580bf8}
\soustitre{Research programs}
\label{sec:org021dd81}
