...
\titre{Publications}
\label{sec:org83200b6}
\soustitre{Refereed papers (in English)}
\label{sec:orgcd5c76f}
...
N. A. Andriamanantena, C. Gaufreteau and L. Doyen) \emph{Revision for
...
F. Fabre). \emph{Phytopatology}, 2022, in press [ \href{bib/MDFD.bib}{bib} ; \href{doc/MDFD-FILE.pdf}{file} ; \href{https://apsjournals.apsnet.org/doi/10.1094/PHYTO-10-21-0449-R}{link} ]
...
\item \textbf{The high cost of noncompliance with mandatory pest control.}
With Estelle Gozlan and Emmanuel Paroissien. [ \href{doc/RISCA-FILE.pdf}{file} ]
...
France.} With Tina Rambonilaza and Jean Dubé.
\item \textbf{Socio-spatial Distribution of Housing Wealth and Capital Gains:
Evidence from a French Region Over the Last 50 Years.} With
Thibault Le Corre.
\item \textbf{Impact Evaluation of Policies Supporting Homeownership: Evidence
from France.} With Rémi Lei, Olivier Dupré and Julie Le Gallo.
\end{itemize}

\soustitre{Working papers}
\label{sec:org66cc11e}
...
\titre{Communications}
\label{sec:org4da6f38}

\begin{description}
\item[{2021}] \textbf{Journées INRAE--SFER--CIRAD} (March, France) ; \textbf{Atelier
Vin et Société} (Institut d’études avancées de Paris) ; \textbf{Séminaire
SMART-LERECO} (October, Rennes, France).
...
\label{sec:org19d764a}
\soustitre{Research programs}
\label{sec:org77e7fbd}

\begin{itemize}
\item SERENA (2022-2025) funded by EJP SOIL, European Joint Program
\item LOCUS (2022-2025) funded by ANR, \emph{Agence Nationale de la
Recherche}
\item OMISEP (2022-2024) funded by \emph{ADEME}
...
\label{sec:org0acd969}

\begin{center}
\begin{tabular}{llrll}
\textbf{Course} & \textbf{Place} & \textbf{Hours} & \textbf{Formation} & \textbf{Period}\\
\hline
Econometrics & SciencesPo Dijon & 24 & Undergraduate & 2018--2022 (4 years)\\
